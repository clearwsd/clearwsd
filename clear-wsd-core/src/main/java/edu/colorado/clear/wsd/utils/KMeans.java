...
import static edu.colorado.clear.wsd.utils.VectorMathUtils.div;
import static edu.colorado.clear.wsd.utils.VectorMathUtils.dot;
import static edu.colorado.clear.wsd.utils.VectorMathUtils.normalize;
import static edu.colorado.clear.wsd.utils.VectorMathUtils.sampleUniform;
...
public class KMeans<T> {
    ...
    private void distanceToCentroid(KmeansPoint point, KmeansCentroid centroid) {
        float total = dot(centroid.point, point.point);
    ...
    public static class KmeansCentroid extends Point {
